...
Source0  : https://cran.r-project.org/src/contrib/haven_2.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590374196
...
/usr/lib64/R/library/haven/tests/testthat/test-labelled-pillar.txt
